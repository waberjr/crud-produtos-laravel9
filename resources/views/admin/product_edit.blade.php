    ...
    <section class="text-gray-600">
        <div class="container px-5 py-24 mx-auto">
            <div class="lg:w-2/4 w-full mx-auto overflow-auto">
                    ...
                    <div class="flex flex-wrap">
                        ...
                        @if ($product->cover)
                            <div class="p-2 w-full">
                                ...
                                <button type="submit" class="mt-3 text-indigo-500 inline-flex items-center" form="deleteForm">Deletar imagem</button>
                            </div>
                        @endif
                ...
                <form id="deleteForm" action="{{ route('admin.product.destroyImage', $product->id) }}" method="POST">
                    @method('delete')
                    @csrf
                </form>
            </div>
